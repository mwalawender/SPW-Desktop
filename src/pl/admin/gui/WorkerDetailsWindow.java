 ...
 * @version 2011-04-12
 */
public class WorkerDetailsWindow {
	...
	private void createTableWithProjects() {
		...
		try {
			employeeProjects = dBOperations
					.getProjectsForSpecifiedWorker(AdministratorWindow.emailOfUserToDelete);
		} catch (Exception e) {
	...
	private void createTableWithTasks() {
		...
		try {
			employeeTasks = dBOperations
					.getTasksForSpecifiedWorker(AdministratorWindow.emailOfUserToDelete);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
