...
public class AddWorkerWindow extends JFrame {
	...
	static AddWorkerWindow frame;
	String mWorkerFirstName, mWorkerLastName, mWorkerPosition, mWorkerSection,
	...
	public AddWorkerWindow() {
		setTitle("Dodaj nowego u¿ytkownika");
		...
		JButton btnAddWorker = new JButton("Dodaj");
		btnAddWorker.setBounds(10, 303, 96, 42);
	...
	public void addNewWorkerToDB() {
		...
		if (mWorkerFirstName.isEmpty() || mWorkerLastName.isEmpty()
			...
			JOptionPane.showMessageDialog(AddWorkerWindow.this,
